    ...
    <main className="page-main">
      ...
      <header className="app-header">
        <div className="app-header-left">
          ...
          >
            <span style={{ color: 'var(--accent-green)' }}>◆</span> SPORTS_AI
          </span>
          <span style={{
            fontSize: '11px',
        ...
        <div className="app-header-right" style={{ alignItems: 'center' }}>
          <span>
          ...
          <div style={{ width: '1px', height: '16px', background: 'var(--border-primary)', margin: '0 8px' }}></div>
          <button 
            onClick={() => router.push('/')}
            style={{
